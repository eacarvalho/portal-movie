    ...
    .directive('nouiSlider', function() {
      ...
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          var start = ( attrs.start ? attrs.start : 0 );
          var range = ( attrs.range ? attrs.range : 0 );
          var startPoint;
          ...
          // settings
          var step = ( attrs.step ? parseInt(attrs.step) : 0 );
          var min = ( attrs.min ? parseInt(attrs.min) : 0 );
          var max = ( attrs.max ? parseInt(attrs.max) : 10 );
